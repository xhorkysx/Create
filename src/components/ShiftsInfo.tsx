        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm text-gray-500 flex items-center gap-1">
              ...
              {shiftData?.date} - {selectedDate.toLocaleDateString('cs-CZ', { weekday: 'long' })}
            </p>
        ...
        <div>
          {shiftData.departments.length === 0 || 
           (shiftData.departments.length === 1 && shiftData.departments[0].name.includes('Žádná')) ? (
            ...
            <div className="flex flex-wrap gap-2 min-w-0" style={{ width: '100%' }}>
              {shiftData.departments.map((department, deptIndex) => (
                <div key={deptIndex} className="bg-gray-50 rounded-lg p-2 min-w-0" style={{ width: 'calc(20% - 8px)', flexShrink: 0 }}>
                  <h4 className="text-sm font-semibold text-gray-800 mb-2 border-b border-gray-200 pb-1 truncate">
                    {department.name}
                  </h4>
